...
use QuetzalStudio\PhpSnapBi\Services\InternalAccountInquiry\AccountInquiry;
use QuetzalStudio\PhpSnapBi\Services\InternalAccountInquiry\Payload;

test('internal account inquiry', function () {
    $privateKey = null;
    ...
    expect($data['responseCode'])->toBeString()->toBe('2001500');
});
