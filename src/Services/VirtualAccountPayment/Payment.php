...
namespace QuetzalStudio\PhpSnapBi\Services\VirtualAccountPayment;
...
class Payment implements Service
{
    use HasService;
    ...
    protected string $endpoint = '/:version/transfer-va/payment-intrabank';
